  ...
  describe('Part II', function() {
    ...
    describe('some', function() {
      ...
      it('should fail for a set containing no matching values', function() {
        ...
        // the behavior described by the `it` string
        // throw new Error('This test is missing.');
        expect(_.some([2, 3, 4], function(element) { element === 1; })).to.be.false;
      });
    ...
    describe('extend', function() {
      ...
      it('should override properties found on the destination', function() {
        ...
        var destination = { a : 1 };
        var source = { a : 2};
        expect(_.extend(destination, source)).to.eql({a : 2});
      });
    ...
    describe('defaults', function() {
      ...
      it('should copy any property whose key is not already set on the target', function() {
        ...
        var source = { c : 4, e : 'hello', f : false, g : 1 };
        expect(_.defaults(destination, source)).to.eql({ a : 1, b : 2, c : 3, e : 'hello', f : false, g : 1 });
      });
